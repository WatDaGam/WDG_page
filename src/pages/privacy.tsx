...
const KoreanList = styled.ol`
    list-style: none;
    counter-reset: custom-counter;

    > li {
        counter-increment: custom-counter;
        text-indent: -20px; // 번호를 왼쪽으로 이동
        padding-left: 20px; // 텍스트에 대한 왼쪽 패딩 적용
        margin-left: 20px; // 전체 목록 항목에 대한 왼쪽 마진 적용
...
// 번호와 괄호 스타일 리스트
const NumBraceList = styled.ol`
    list-style: none;
    counter-reset: item;
    padding-left: 0; // 목록의 왼쪽 패딩을 제거
...
const NumDotList = styled.ol`
    ...
    > li {
        ...
        &::before {
            content: counter(item) ". ";
            text-indent: 0; // ::before 가상 요소에 대한 텍스트 들여쓰기 제거
        }
    }
`;

// @counter-style 규칙은 전역 스타일로 추가
  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <PStyle>
          <StrongStyle>왔다감</StrongStyle>(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
        </PStyle>
        ...
        <NumDotList>
          <li>필수 수집 정보: <strong>닉네임</strong></li>
        </NumDotList>
        ...
        <NumDotList>
          <li>필수 수집 정보: <strong>접속지 정보</strong></li>
        </NumDotList>
        ...
        <NumDotList>
          ...
          <li><strong>이용자가 고객센터의 상담, 게시판에서의 활동 등 회사의 서비스를 이용하는 과정에서 이용자가 입력하는 방식</strong></li>
          <li><strong>기기에서 제공하는 위치 정보를 받아오는 방식</strong></li>
        </NumDotList>
        ...
        <NumBraceList>
          <li>성명: <strong>백용민</strong></li>
          <li>직책: <strong>CDO</strong></li>
          <li>전화번호: <strong>010-7380-3307</strong></li>
          <li>이메일: <strong>support@watdagam.com</strong></li>
        </NumBraceList>
        ...
        <p>
          제1조 본 방침은 <strong>2023.12.19</strong>부터 시행됩니다.<br />
          더 궁금한 사항이 있다면 support@watdagam.com으로 문의해주세요.
        </p>
      </Wrapper>
    </>
  )
...
export const Head: HeadFC = () => <title>개인정보처리방침 - WDG</title>
